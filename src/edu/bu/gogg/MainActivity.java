...
//static final LatLng WholeFoodsSouth = new LatLng(42.345897,-71.108193 ); 
//Location location;
//final LatLng youarehere = new LatLng(location.getLatitude(), location.getLongitude());
    ...
    private void initilizeMap() {
        if (googleMap == null) {
           ...
           // Marker Y = googleMap.addMarker(new MarkerOptions(). 
       	   	//	   position(youarehere).title("You are here"). 
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            // Marker T10 = googleMap.addMarker(new MarkerOptions().
              //          position(RhythmWraps).title("Rhythm Wraps"). 
          ...
          /* Marker T8 = googleMap.addMarker(new MarkerOptions().
                       position(ShawsWest).title("Shaws West").
